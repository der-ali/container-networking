...
func main() {
	...
	b := backend{
		saddr:   ip2int("172.16.0.1"),
		daddr:   ip2int("172.16.0.2"),
		hwaddr:  hwaddr2bytes("a2:33:02:13:d5:ae"),
		ifindex: uint16(ifaceDest.Index),
	}

	if err := objs.Backends.Update(ip2int("10.0.0.10"), b, ebpf.UpdateAny); err != nil {
